...
Это относится и к аргументам. Более того, если там объявить переменную, уже
существующую снаружи функции, или аргумент с уже использованным именем, то :warning: значение наружной переменной *никак не изменится*: 
...
В результате присваивания `x` значения 10 внутри функции, 
