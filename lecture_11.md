...
(следующий уровень в иерархии типов &mdash; уровень 4-колёсности), далее идут тип кузова, тип двигателя, и т.п., но всё это
в общем не меняет того, что руль и 2-3 педали дают возможность управлять любой машиной примерно
 одинаковым способом (полиморфизм). Инкапсуляция же &mdash; это тот факт, что такие вещи, как тип или объём двигателя, 
...
Язык Python, несмотря на свою поддержку различных парадигм программирования &mdash; структурной, императивной, функциональной --
...
Возникает забавный вопрос: а можно ли поменять поле класса и что будет с объектами этого класса? Ответ &mdash; в духе Python --
очень логичен.
